...
ifneq ($(filter bluejay panther cheetah lynx felix tangorpro, $(LINEAGE_BUILD)),)
PRODUCT_PACKAGES += \
    PixelConnectivityOverlay2022
else ifneq ($(filter shiba husky akita, $(LINEAGE_BUILD)),)
PRODUCT_PACKAGES += \
    PixelConnectivityOverlay2023
else ifneq ($(filter comet tokay caiman komodo, $(LINEAGE_BUILD)),)
PRODUCT_PACKAGES += \
